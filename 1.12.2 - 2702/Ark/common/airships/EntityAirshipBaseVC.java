package com.viesys.viesysmachines.common.entity.airships;

import com.viesys.viesysmachines.api.EnumsVC;
import com.viesys.viesysmachines.api.FuelVC;
...
public class EntityAirshipBaseVC extends EntityBaseVC {
	...
	protected void waterPartsDrop()
	{
		if (!this.world.isRemote)
    	{
    	    ...
    	    if (drop1 < 75)
        	{
    	    	this.dropItemWithOffset(ItemsVC.AIRSHIP_BALLOON, 1, 0.0F);
        	}
    	    
    	    if (drop2 < 55)
        	{
    	    	this.dropItemWithOffset(ItemsVC.AIRSHIP_ENGINE, 1, 0.0F);
    	    ...
    	    if (drop4 < 15)
        	{
    	    	this.dropItemWithOffset(ItemsVC.AIRSHIP_IGNITION, 1, 0.0F);
        	}
    ...
    public static int getItemBurnTime(ItemStack stack)
    {
        ...
        else
        {
            ...
            if(item == ItemsVC.VIESOLINE_PELLETS) return (ViesCraftConfig.viesolineBurnTime * 20) * 10;
