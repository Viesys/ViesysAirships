...
import com.viesys.viesysmachines.client.gui.airship.main.GuiAirshipMainMenu;
...
public class GuiHandler implements IGuiHandler {
	...
	public static final int GUI_AIRSHIP_MAIN_MENU = 11;
	...
	*/
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) 
	{
		...
		if (ID == GUI_AIRSHIP_MAIN_MENU)
		{
			return new ContainerAirshipMenuMain(player.inventory, (EntityMachineAirship)player.getRidingEntity());
		}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) 
	{
		...
		if (ID == GUI_AIRSHIP_MAIN_MENU)
		{
			return new GuiAirshipMainMenu(player.inventory, (EntityMachineAirship)player.getRidingEntity());
		}
