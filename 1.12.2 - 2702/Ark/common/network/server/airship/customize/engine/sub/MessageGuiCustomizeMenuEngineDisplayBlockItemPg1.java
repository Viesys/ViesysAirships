...
public class MessageGuiCustomizeMenuEngineDisplayBlockItemPg1 extends MessageBase<MessageGuiCustomizeMenuEngineDisplayBlockItemPg1> {
	...
	{
		player.openGui(ViesysMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_ENGINE_BLOCKITEM, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
