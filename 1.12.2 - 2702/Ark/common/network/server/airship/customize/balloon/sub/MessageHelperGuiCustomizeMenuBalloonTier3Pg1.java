...
public class MessageHelperGuiCustomizeMenuBalloonTier3Pg1 extends MessageBase<MessageHelperGuiCustomizeMenuBalloonTier3Pg1> {
	...
	{
		buf.writeInt(GuiCustomizeMenuBalloonTier3Pg1.metaInfo);
	}
	
	@Override
	public void handleClientSide(MessageHelperGuiCustomizeMenuBalloonTier3Pg1 message, EntityPlayer player) 
	{
		
	}
	
	@Override
	public void handleServerSide(MessageHelperGuiCustomizeMenuBalloonTier3Pg1 message, EntityPlayer player) 
	{
