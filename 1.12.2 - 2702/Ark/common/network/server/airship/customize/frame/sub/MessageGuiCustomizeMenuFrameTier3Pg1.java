...
public class MessageGuiCustomizeMenuFrameTier3Pg1 extends MessageBase<MessageGuiCustomizeMenuFrameTier3Pg1> {
	...
	{
		player.openGui(ViesysMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_FRAME_TIER3_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
