...
import com.viesys.viesysmachines.client.sound.JukeboxMovingSoundVC;
...
public class MessageGuiPlayMusicArea extends MessageBase<MessageGuiPlayMusicArea> {
	...
	public void handleClientSide(MessageGuiPlayMusicArea message, EntityPlayer player) 
	{
		...
		soundHandler.playSound(new JukeboxMovingSoundVC(message.airship, SoundEvent.REGISTRY.getObject(new ResourceLocation("minecraft:record.ward"))
				//EnumsVC.AirshipSong.byId(message.airship.metaJukeboxSelectedSong).getSong()
				));
	}
