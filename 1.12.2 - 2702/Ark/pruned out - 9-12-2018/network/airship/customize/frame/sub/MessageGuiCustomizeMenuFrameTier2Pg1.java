...
public class MessageGuiCustomizeMenuFrameTier2Pg1 extends MessageBase<MessageGuiCustomizeMenuFrameTier2Pg1> {
	...
	{
		player.openGui(ViesMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_FRAME_TIER2_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
