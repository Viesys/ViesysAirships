...
public class MessageGuiCustomizeMenuFrameTier1Pg1 extends MessageBase<MessageGuiCustomizeMenuFrameTier1Pg1> {
	...
	{
		player.openGui(ViesMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_FRAME_TIER1_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
