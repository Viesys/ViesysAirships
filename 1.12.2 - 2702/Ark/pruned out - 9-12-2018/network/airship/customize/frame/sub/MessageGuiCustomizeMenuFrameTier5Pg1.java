...
public class MessageGuiCustomizeMenuFrameTier5Pg1 extends MessageBase<MessageGuiCustomizeMenuFrameTier5Pg1> {
	...
	{
		player.openGui(ViesMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_FRAME_TIER5_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
