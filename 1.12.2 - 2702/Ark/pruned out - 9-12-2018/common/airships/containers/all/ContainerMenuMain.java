...
import com.vies.viesmachines.common.entity.airships.slots.ModuleBombSlotVC;
...
public class ContainerMenuMain extends ContainerVC {
	...
	public ContainerMenuMain(IInventory playerInv, EntityAirshipCore airshipIn) 
	{
		...
		{
			this.addSlotToContainer(new FuelSlot(this.airship.inventory, 0, 500, 500));
		}
		else
		{
			this.addSlotToContainer(new FuelSlot(this.airship.inventory, 0, 147, 22));
		}
