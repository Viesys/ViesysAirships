package com.vies.viesmachines.common.entity;
...
public class EntityBombBig extends EntityThrowable {
	...
	protected void onImpact(RayTraceResult result)
	{
		...
		else
		{
	        ...
	        {
				this.world.createExplosion(this, this.posX, this.posY, this.posZ, EnumsVM.Bombs.byId(2).getExplosionStrength(), true);
				this.setDead();
	        }
			else
			{
