...
import com.vies.viesmachines.network.server.airship.customize.MessageHelperGuiCustomizeMenuChangeName;
import com.vies.viesmachines.network.server.airship.customize.MessageHelperGuiCustomizeMenuUndo;
...
public class GuiCustomizeMenuChangeName extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVM.buttonA12 = new GuiButtonGeneral1VC(12, this.guiLeft + 22, this.guiTop + 58+12, 42, 14, References.localNameVC("vc.button.apply"), 1);
		GuiVM.buttonA13 = new GuiButtonGeneral1VC(13, this.guiLeft + 112, this.guiTop + 58+12, 42, 14, References.localNameVC("vc.button.back"), 2);
		
		GuiVM.buttonA20 = new GuiButtonGeneral2VC(20, this.guiLeft + 148, this.guiTop + 33+4, 14, 14, "", 1);
		...
		this.buttonList.add(GuiVM.buttonA20);
		this.buttonList.add(GuiVM.buttonA12);
		this.buttonList.add(GuiVM.buttonA13);
		
		GuiVM.buttonA20.enabled = false;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
        ...
        {
        	GuiVM.buttonA12.enabled = true;
        }
		else
		{
			GuiVM.buttonA12.enabled = false;
		}
		...
		GlStateManager.pushMatrix();
		{
	        ...
	        this.drawCenteredString(fontRenderer, Integer.toString(CostsVM.RENAME_COST), 0, 0, Color.WHITE.getRGB());
		}
		GlStateManager.popMatrix();
	}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		&& mouseY >= this.guiTop + 73 && mouseY <= this.guiTop + 86)
		{
			...
			text.add(TextFormatting.LIGHT_PURPLE + References.localNameVC("vc.main.costs")+ " " + CostsVM.RENAME_COST + " " + References.localNameVC("vc.main.engine.cost.1"));
