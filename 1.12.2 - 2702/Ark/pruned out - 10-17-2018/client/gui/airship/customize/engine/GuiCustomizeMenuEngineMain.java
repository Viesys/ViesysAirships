package com.vies.viesmachines.client.gui.airship.customize.engine;
...
import com.vies.viesmachines.network.server.airship.customize.engine.sub.MessageGuiCustomizeMenuEngineDisplayBlockItemPg1;
import com.vies.viesmachines.network.server.airship.customize.engine.sub.MessageGuiCustomizeMenuEngineDisplayHeadPg1;
import com.vies.viesmachines.network.server.airship.customize.engine.sub.MessageGuiCustomizeMenuEngineDisplayParticlePg1;
import com.vies.viesmachines.network.server.airship.customize.engine.sub.MessageGuiCustomizeMenuEngineDisplaySupporterHeadPg1;
import com.vies.viesmachines.network.server.airship.customize.engine.sub.MessageGuiCustomizeMenuEngineDisplaySymbolPg1;
...
public class GuiCustomizeMenuEngineMain extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVM.buttonT1 = new GuiButtonGeneral1VC(11, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 0), 69, 14, References.localNameVC("vc.button.symbols"), 0);
		GuiVM.buttonT2 = new GuiButtonGeneral1VC(12, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 1), 69, 14, References.localNameVC("vc.button.blockitems"), 0);
		GuiVM.buttonT3 = new GuiButtonGeneral1VC(14, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 2), 69, 14, References.localNameVC("vc.button.heads"), 0);
		GuiVM.buttonT4 = new GuiButtonGeneral1VC(15, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 3), 69, 14, References.localNameVC("vc.button.supporterheads"), 0);
		
		//Holidays
		GuiVM.button11 = new GuiButtonGeneral2VC(111, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 4), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.newyears"), false), 3);
		GuiVM.button12 = new GuiButtonGeneral2VC(112, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 4), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.valentinesday"), false), 3);
		GuiVM.button13 = new GuiButtonGeneral2VC(113, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 4), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.easter"), false), 3);
		GuiVM.button14 = new GuiButtonGeneral2VC(114, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 4), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.4thofjuly"), false), 3);
		GuiVM.button15 = new GuiButtonGeneral2VC(115, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 4), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.halloween"), false), 3);
		GuiVM.button16 = new GuiButtonGeneral2VC(116, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 4), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.thanksgiving"), false), 3);
		GuiVM.button17 = new GuiButtonGeneral2VC(117, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 4), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.christmas"), false), 3);
		
		//Creative
		GuiVM.button01 = new GuiButtonGeneral2VC(101, this.guiLeft - 67-37, this.guiTop + startPlace - 5 + (14 * 0), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.newyears"), false), 3);
		GuiVM.button02 = new GuiButtonGeneral2VC(102, this.guiLeft - 67-37, this.guiTop + startPlace - 5 + (14 * 1), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.valentinesday"), false), 3);
		GuiVM.button03 = new GuiButtonGeneral2VC(103, this.guiLeft - 67-37, this.guiTop + startPlace - 5 + (14 * 2), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.easter"), false), 3);
		GuiVM.button04 = new GuiButtonGeneral2VC(104, this.guiLeft - 67-37, this.guiTop + startPlace - 5 + (14 * 3), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.4thofjuly"), false), 3);
		GuiVM.button05 = new GuiButtonGeneral2VC(105, this.guiLeft - 67-37, this.guiTop + startPlace - 5 + (14 * 4), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.halloween"), false), 3);
		GuiVM.button06 = new GuiButtonGeneral2VC(106, this.guiLeft - 67-37, this.guiTop + startPlace - 5 + (14 * 5), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.thanksgiving"), false), 3);
		GuiVM.button07 = new GuiButtonGeneral2VC(107, this.guiLeft - 67-37, this.guiTop + startPlace - 5 + (14 * 6), 69, 14, this.stringToRainbow(References.localNameVC("vc.button.christmas"), false), 3);
		
		GuiVM.buttonA16 = new GuiButtonGeneral1VC(16, this.guiLeft + 21, this.guiTop + 177, 60, 14, References.localNameVC("vc.button.particles"), 0);
		...
		this.buttonList.add(GuiVM.buttonA16);
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		{
			this.drawRotatingItemStack(new ItemStack(ItemsVM.ITEM_DISPLAY_SYMBOL, 1, this.airship.engineDisplayTypeVisual), this.guiLeft + 51, this.guiTop + 80);
		}
