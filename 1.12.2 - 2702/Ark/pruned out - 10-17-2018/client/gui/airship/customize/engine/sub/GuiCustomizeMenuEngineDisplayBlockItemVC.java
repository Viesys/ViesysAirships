...
import com.vies.viesmachines.common.entity.airships.containers.all.ContainerCustomizeEngineBlock;
import com.vies.viesmachines.network.NetworkHandler;
import com.vies.viesmachines.network.server.airship.customize.engine.MessageGuiCustomizeMenuEngineMain;
import com.vies.viesmachines.network.server.airship.customize.engine.sub.MessageHelperGuiCustomizeMenuEngineDisplayBlockItem;
import com.vies.viesmachines.network.server.airship.customize.engine.sub.MessageHelperGuiCustomizeMenuEngineDisplayBlockItemDefault;
...
public class GuiCustomizeMenuEngineDisplayBlockItemVC extends GuiContainerVC {
    ...
    public void initGui() 
    {
		...
		GuiVM.button502 = new GuiButtonGeneral2VC(502, this.guiLeft + 58, this.guiTop + 177, 48, 14, References.localNameVC("vc.button.default"), 1);
    	...
    	GuiVM.button501 = new GuiButtonGeneral1VC(501, this.guiLeft + 7, this.guiTop + 177, 48, 14, References.localNameVC("vc.button.apply"), 1);
    }
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		if(this.airship.getStoredRedstone() >= CostsVM.ENGINE_DISPLAY_SYMBOL_COST)
		{
			if(currentItem == previousItem)
			{
				if(currentMeta != previousMeta)
