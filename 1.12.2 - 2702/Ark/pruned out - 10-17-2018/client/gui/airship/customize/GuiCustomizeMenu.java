package com.vies.viesmachines.client.gui.airship.customize;
...
import com.vies.viesmachines.network.server.airship.customize.MessageGuiCustomizeMenuChangeName;
...
public class GuiCustomizeMenu extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVM.buttonA21 = new GuiButtonGeneral1VC(21, this.guiLeft + 28, this.guiTop + 143, 42, 14, References.localNameVC("vc.main.options"), 0);
		GuiVM.buttonA22 = new GuiButtonGeneral1VC(22, this.guiLeft + 106, this.guiTop + 143, 42, 14, References.localNameVC("vc.main.options"), 0);
		GuiVM.buttonA23 = new GuiButtonGeneral1VC(23, this.guiLeft + 28, this.guiTop + 179, 42, 14, References.localNameVC("vc.main.options"), 0);
		GuiVM.buttonA24 = new GuiButtonGeneral1VC(24, this.guiLeft + 106, this.guiTop + 179, 42, 14, References.localNameVC("vc.main.options"), 0);
		
		GuiVM.buttonA11 = new GuiButtonGeneral1VC(11, this.guiLeft + 22, this.guiTop + 44, 54, 14, References.localNameVC("vc.main.changename"), 0);
		...
		this.buttonList.add(GuiVM.buttonA21);
		this.buttonList.add(GuiVM.buttonA22);
		this.buttonList.add(GuiVM.buttonA23);
		this.buttonList.add(GuiVM.buttonA24);
		
		this.buttonList.add(GuiVM.buttonA11);
