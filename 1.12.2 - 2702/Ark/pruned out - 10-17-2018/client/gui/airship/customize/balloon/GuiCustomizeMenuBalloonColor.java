...
import com.vies.viesmachines.network.server.airship.customize.balloon.MessageHelperGuiCustomizeMenuBalloonColor;
...
public class GuiCustomizeMenuBalloonColor extends GuiContainerVC {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
        ...
        GlStateManager.pushMatrix();
		{
	        ...
	        this.drawCenteredString(fontRenderer, Integer.toString(CostsVM.BALLOON_PATTERN_COLOR_COST), 0, 0, redstoneColor.getRGB());
		}
		GlStateManager.popMatrix();
		
		if(this.airship.storedRedstone >= CostsVM.BALLOON_PATTERN_COLOR_COST)
		{
