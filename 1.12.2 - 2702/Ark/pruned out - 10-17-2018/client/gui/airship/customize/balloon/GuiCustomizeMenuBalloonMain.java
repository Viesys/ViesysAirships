package com.vies.viesmachines.client.gui.airship.customize.balloon;
...
import com.vies.viesmachines.network.server.airship.customize.balloon.MessageGuiCustomizeMenuBalloonColor;
import com.vies.viesmachines.network.server.airship.customize.balloon.MessageHelperGuiCustomizeMenuBalloonColorDefault;
import com.vies.viesmachines.network.server.airship.customize.balloon.MessageHelperGuiCustomizeMenuBalloonTransparent;
import com.vies.viesmachines.network.server.airship.customize.balloon.sub.MessageGuiCustomizeMenuBalloonTier1Pg1;
import com.vies.viesmachines.network.server.airship.customize.balloon.sub.MessageGuiCustomizeMenuBalloonTier2Pg1;
import com.vies.viesmachines.network.server.airship.customize.balloon.sub.MessageGuiCustomizeMenuBalloonTier3Pg1;
import com.vies.viesmachines.network.server.airship.customize.balloon.sub.MessageGuiCustomizeMenuBalloonTier4Pg1;
import com.vies.viesmachines.network.server.airship.customize.balloon.sub.MessageGuiCustomizeMenuBalloonTier5Pg1;
...
public class GuiCustomizeMenuBalloonMain extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVM.buttonT1 = new GuiButtonGeneral1VC(11, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 0), 69, 14, References.localNameVC("vc.main.patterns") + " - " + References.localNameVC("vc.enum.tier.1"), 0);
		GuiVM.buttonT2 = new GuiButtonGeneral1VC(12, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 1), 69, 14, References.localNameVC("vc.main.patterns") + " - " + References.localNameVC("vc.enum.tier.2"), 0);
		GuiVM.buttonT3 = new GuiButtonGeneral1VC(13, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 2), 69, 14, References.localNameVC("vc.main.patterns") + " - " + References.localNameVC("vc.enum.tier.3"), 0);
		GuiVM.buttonT4 = new GuiButtonGeneral1VC(14, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 3), 69, 14, References.localNameVC("vc.main.patterns") + " - " + References.localNameVC("vc.enum.tier.4"), 0);
		GuiVM.buttonT5 = new GuiButtonGeneral1VC(15, this.guiLeft + 17, this.guiTop + startPlace - 4 + (15 * 4), 69, 14, References.localNameVC("vc.main.patterns") + " - " + References.localNameVC("vc.enum.tier.5"), 0);
		...
		if(this.airship.mainTierBalloon > 4)
        {
			if(GuiVM.button16.enabled)
			{
				...
				&& mouseY >= this.guiTop + 160 && mouseY <= this.guiTop + 173)
				{
					...
					text.add(TextFormatting.LIGHT_PURPLE + References.localNameVC("Costs " + CostsVM.BALLOON_PATTERN_COLOR_COST + " Redstone"));
			...
			if(GuiVM.button17.enabled)
			{
				...
				&& mouseY >= this.guiTop + 180 && mouseY <= this.guiTop + 193)
				{
					...
					text.add(TextFormatting.LIGHT_PURPLE + References.localNameVC("Costs " + CostsVM.BALLOON_PATTERN_TRANSPARENCY_COST + " Redstone"));
