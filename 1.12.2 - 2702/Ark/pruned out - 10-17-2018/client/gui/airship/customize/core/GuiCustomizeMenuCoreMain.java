package com.vies.viesmachines.client.gui.airship.customize.core;
...
import com.vies.viesmachines.network.server.airship.customize.core.sub.MessageGuiCustomizeMenuCoreModelBalloonPg1;
import com.vies.viesmachines.network.server.airship.customize.core.sub.MessageGuiCustomizeMenuCoreModelEnginePg1;
import com.vies.viesmachines.network.server.airship.customize.core.sub.MessageGuiCustomizeMenuCoreModelFramePg1;
...
public class GuiCustomizeMenuCoreMain extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVM.buttonT1 = new GuiButtonGeneral1VC(11, this.guiLeft + 17, this.guiTop + startPlace - 4 + (22 * 0), 69, 14, References.localNameVC("vc.main.frame"), 0);
		GuiVM.buttonT2 = new GuiButtonGeneral1VC(12, this.guiLeft + 17, this.guiTop + startPlace - 4 + (22 * 1), 69, 14, References.localNameVC("vc.main.engine"), 0);
		GuiVM.buttonT3 = new GuiButtonGeneral1VC(13, this.guiLeft + 17, this.guiTop + startPlace - 4 + (22 * 2), 69, 14, References.localNameVC("vc.main.balloon"), 0);
