...
import com.vies.viesmachines.network.server.airship.customize.core.sub.MessageHelperGuiCustomizeMenuCoreModelFrame;
...
public class GuiCustomizeMenuCoreModelFramePg1 extends GuiCustomizeMenuCoreModelVC {
    ...
    public void initGui() 
    {
		...
		this.buttonList.add(GuiVM.buttonA00);
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		if(airship.getStoredRedstone() >= CostsVM.CORE_MODEL_FRAME_COST
		&& this.metaInfo != this.airship.coreModelVisualFrame)
		{
    ...
    private void grayOutSelectedButton()
    {
    	...
    	{
    		GuiVM.buttonA00.enabled = false;
    	}
    	else
    	{
    		GuiVM.buttonA00.enabled = true;
    	}
    	...
    	{
    		GuiVM.buttonA04.enabled = false;
    	}
    	else
    	{
    		GuiVM.buttonA04.enabled = true;
    	}
    }
