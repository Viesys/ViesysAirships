...
public class GuiCustomizeMenuCoreModelVC extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVM.buttonA00 = new GuiButtonGeneral1VC( 0, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 0), 76, 14, References.localNameVC("vc.enum.visualcoreframe.0"), 0);
		GuiVM.buttonA01 = new GuiButtonGeneral1VC( 1, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 1), 76, 14, References.localNameVC("vc.enum.visualcoreframe.1"), 0);
		GuiVM.buttonA02 = new GuiButtonGeneral1VC( 2, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 2), 76, 14, References.localNameVC("vc.enum.visualcoreframe.2"), 0);
		GuiVM.buttonA03 = new GuiButtonGeneral1VC( 3, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 3), 76, 14, References.localNameVC("vc.enum.visualcoreframe.3"), 0);
		GuiVM.buttonA04 = new GuiButtonGeneral1VC( 4, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 4), 76, 14, References.localNameVC("vc.enum.visualcoreframe.4"), 0);
    	
    	GuiVM.buttonB00 = new GuiButtonGeneral1VC( 0, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 0), 76, 14, References.localNameVC("vc.enum.visualcoreengine.0"), 0);
		GuiVM.buttonB01 = new GuiButtonGeneral1VC( 1, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 1), 76, 14, References.localNameVC("vc.enum.visualcoreengine.1"), 0);
		GuiVM.buttonB02 = new GuiButtonGeneral1VC( 2, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 2), 76, 14, References.localNameVC("vc.enum.visualcoreengine.2"), 0);
		GuiVM.buttonB03 = new GuiButtonGeneral1VC( 3, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 3), 76, 14, References.localNameVC("vc.enum.visualcoreengine.3"), 0);
		GuiVM.buttonB04 = new GuiButtonGeneral1VC( 4, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 4), 76, 14, References.localNameVC("vc.enum.visualcoreengine.4"), 0);
    	
    	GuiVM.buttonC00 = new GuiButtonGeneral1VC( 0, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 0), 76, 14, References.localNameVC("vc.enum.visualcoreballoon.0"), 0);
		GuiVM.buttonC01 = new GuiButtonGeneral1VC( 1, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 1), 76, 14, References.localNameVC("vc.enum.visualcoreballoon.1"), 0);
		GuiVM.buttonC02 = new GuiButtonGeneral1VC( 2, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 2), 76, 14, References.localNameVC("vc.enum.visualcoreballoon.2"), 0);
		GuiVM.buttonC03 = new GuiButtonGeneral1VC( 3, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 3), 76, 14, References.localNameVC("vc.enum.visualcoreballoon.3"), 0);
		GuiVM.buttonC04 = new GuiButtonGeneral1VC( 4, this.guiLeft + startPlaceLeft, this.guiTop + startPlaceTop + (18 * 4), 76, 14, References.localNameVC("vc.enum.visualcoreballoon.4"), 0);
    }
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
        ...
        GlStateManager.pushMatrix();
		{
	        ...
	        this.drawCenteredString(fontRenderer, Integer.toString(CostsVM.CORE_MODEL_FRAME_COST), 0, 0, redstoneColor.getRGB());
		}
		GlStateManager.popMatrix();
	}
