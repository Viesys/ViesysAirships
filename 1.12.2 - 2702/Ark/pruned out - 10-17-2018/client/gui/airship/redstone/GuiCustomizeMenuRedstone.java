package com.vies.viesmachines.client.gui.airship.redstone;
...
import com.vies.viesmachines.common.entity.airships.containers.all.ContainerMenuRedstone;
import com.vies.viesmachines.network.NetworkHandler;
import com.vies.viesmachines.network.server.airship.redstone.MessageHelperGuiRedstoneMenuConsume;
...
public class GuiCustomizeMenuRedstone extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVM.buttonA12 = new GuiButtonGeneral1VC(12, this.guiLeft + 67, this.guiTop + 94, 42, 14,  References.localNameVC("vc.button.apply"), 1);
