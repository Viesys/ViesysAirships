package com.vies.viesmachines.client.gui.airship.upgrade;
...
import com.vies.viesmachines.common.entity.airships.containers.all.ContainerUpgradeMenu;
import com.vies.viesmachines.init.InitItemsVC;
import com.vies.viesmachines.network.NetworkHandler;
import com.vies.viesmachines.network.server.airship.upgrade.MessageHelperGuiUpgradeBalloonVC;
import com.vies.viesmachines.network.server.airship.upgrade.MessageHelperGuiUpgradeCoreVC;
import com.vies.viesmachines.network.server.airship.upgrade.MessageHelperGuiUpgradeEngineVC;
import com.vies.viesmachines.network.server.airship.upgrade.MessageHelperGuiUpgradeFrameVC;
...
public class GuiUpgradeMenu extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVM.buttonC1 = new GuiButtonGeneral1VC(11, this.guiLeft + 24, this.guiTop + 88, 14, 14, "", 1);
    	GuiVM.buttonC2 = new GuiButtonGeneral1VC(12, this.guiLeft + 62, this.guiTop + 88, 14, 14, "", 1);
    	GuiVM.buttonC3 = new GuiButtonGeneral1VC(13, this.guiLeft + 100, this.guiTop + 88, 14, 14, "", 1);
    	GuiVM.buttonC4 = new GuiButtonGeneral1VC(14, this.guiLeft + 138, this.guiTop + 88, 14, 14, "", 1);
		...
		this.buttonList.add(GuiVM.buttonC1);
    	this.buttonList.add(GuiVM.buttonC2);
    	this.buttonList.add(GuiVM.buttonC3);
    	this.buttonList.add(GuiVM.buttonC4);
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
    	...
    	GuiVM.buttonC1.enabled = false;
    	GuiVM.buttonC2.enabled = false;
    	GuiVM.buttonC3.enabled = false;
    	GuiVM.buttonC4.enabled = false;
    	GuiVM.buttonC1.visible = false;
    	GuiVM.buttonC2.visible = false;
    	GuiVM.buttonC3.visible = false;
    	GuiVM.buttonC4.visible = false;
    	...
    	if(!this.airship.inventory.getStackInSlot(1).isEmpty())
		{
			...
			&& this.metaInfo == (this.airship.getMainTierCore() + 1))
			{
				GuiVM.buttonC1.enabled = true;
				GuiVM.buttonC1.visible = true;
			}
    	...
    	if(!this.airship.inventory.getStackInSlot(2).isEmpty())
		{
			...
			&& this.metaInfo == (this.airship.getMainTierFrame() + 1))
			{
				GuiVM.buttonC2.enabled = true;
				GuiVM.buttonC2.visible = true;
			}
    	...
    	if(!this.airship.inventory.getStackInSlot(3).isEmpty())
		{
			...
			&& this.metaInfo == (this.airship.getMainTierEngine() + 1))
			{
				GuiVM.buttonC3.enabled = true;
				GuiVM.buttonC3.visible = true;
			}
    	...
    	if(!this.airship.inventory.getStackInSlot(4).isEmpty())
		{
			...
			&& this.metaInfo == (this.airship.getMainTierBalloon() + 1))
			{
				GuiVM.buttonC4.enabled = true;
				GuiVM.buttonC4.visible = true;
			}
