package com.vies.viesmachines.client.entity.machines.flying.renderers;
...
public class RenderMachineFlying extends RenderMachineFlyingBase {
	...
	public RenderMachineFlying(RenderManager renderManagerIn)
    {
    ...
    @Override
    public void doRender(EntityMachineFlying entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
		...
		*/	
    	...
    	if(VMConfiguration.renderNameplates)
    	{
	        ...
	        else
	        {
	    		...
	    		if(entity.getModuleActiveSlot1() == EnumsVM.ModuleType.INFINITE_FUEL_LESSER.getMetadata()
				|| entity.getModuleActiveSlot1() == EnumsVM.ModuleType.INFINITE_FUEL_NORMAL.getMetadata()
				|| entity.getModuleActiveSlot1() == EnumsVM.ModuleType.INFINITE_FUEL_GREATER.getMetadata())
	    		{
	    			
	    		}
	    		else if(entity.getModuleActiveSlot1() == EnumsVM.ModuleType.WATER_LESSER.getMetadata()
    				 || entity.getModuleActiveSlot1() == EnumsVM.ModuleType.WATER_NORMAL.getMetadata()
    				 || entity.getModuleActiveSlot1() == EnumsVM.ModuleType.WATER_GREATER.getMetadata())
	    		{
    ...
    @Override
    public void renderMultipass(EntityMachineFlying entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    	GlStateManager.pushMatrix();
    ...
    public void setupRotation(EntityMachineFlying entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityMachineFlying entity)
    {
        return null;
    }
     ...
     */
    private void renderItemOnPanel(EntityMachineFlying airshipIn, double posXIn, double posYIn, double posZIn, ItemStack itemstackIn)
    {
    	GlStateManager.pushMatrix();
     ...
     */
    private void selectedModelMainFrame(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Get Colors
        float frameRed;
        float frameGreen;
        ...
        {
        	this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/frames/grayscale_bg_" + EnumsVM.VisualFrameSkinBackground.byId(airshipIn.frameSkinTexture).getRegistryName() + ".png"));
        }
        else
        {
        	this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/frames/bg_" + EnumsVM.VisualFrameSkinBackground.byId(airshipIn.frameSkinTexture).getRegistryName() + ".png"));
        }
     ...
     */
    private void selectedModelMultiFrame(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Frame Logic
        if(airshipIn.frameSkinTransparent)
        {
     ...
     */
    private void selectedModelMainEngine(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Get Colors
        float frameRed;
        float frameGreen;
     ...
     */
    private void selectedModelMultiEngine(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Balloon Logic
     ...
     */
    private void selectedModelMainBalloonF(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Get Colors
        float frameRed;
        float frameGreen;
     ...
     */
    private void selectedModelMultiBalloonF(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Frame Logic
        if(airshipIn.frameSkinTransparent)
        {
     ...
     */
    private void selectedModelMainBalloonDS(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Get Colors
        float frameRed;
        float frameGreen;
     ...
     * This is the Balloon Frame Model for the Multipass Render Method.
     */
    private void selectedModelMultiBalloonDS(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Frame Logic
        if(airshipIn.frameSkinTransparent)
        {
     ...
     */
    private void selectedModelMainBalloonB(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Get Colors
        float balloonRed;
        float balloonGreen;
        ...
        {
        	this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/balloons/grayscale_bg_" + EnumsVM.VisualBalloonPattern.byId(airshipIn.balloonPatternTexture).getRegistryName() + ".png"));
        }
        else
        {
        	this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/balloons/bg_" + EnumsVM.VisualBalloonPattern.byId(airshipIn.balloonPatternTexture).getRegistryName() + ".png"));
        }
     ...
     */
    private void selectedModelMultiBalloonB(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Balloon Logic
        if(airshipIn.balloonPatternTransparent)
        {
     ...
     */
    private void selectedModelControlPanel(EntityMachineFlying airshipIn, float partialTicks)
    {
        ...
        {
	        //Core Upgrade
	        this.renderItemOnPanel(airshipIn, 0.93, -0.26, -6.28, new ItemStack(ItemsVM.UPGRADE_CORE, 1, airshipIn.getMainTierCore()));
        }
        if(airshipIn.getMainTierFrame() != 0)
        {
	        //Frame Upgrade
	        this.renderItemOnPanel(airshipIn, 0.315, -0.26, -6.28, new ItemStack(ItemsVM.UPGRADE_FRAME, 1, airshipIn.getMainTierFrame()));
        }
        if(airshipIn.getMainTierEngine() != 0)
        {
	        //Engine Upgrade
	        this.renderItemOnPanel(airshipIn, -0.315, -0.26, -6.28, new ItemStack(ItemsVM.UPGRADE_ENGINE, 1, airshipIn.getMainTierEngine()));
        }
        if(airshipIn.getMainTierBalloon() != 0)
        {
	        //Balloon Upgrade
	        this.renderItemOnPanel(airshipIn, -0.93, -0.26, -6.28, new ItemStack(ItemsVM.UPGRADE_BALLOON, 1, airshipIn.getMainTierBalloon()));
        }
        ...
        {
        	//Module
        	this.renderItemOnPanel(airshipIn, -0.93, 0.43, -5.59, new ItemStack(ItemsVM.MODULE_TYPE, 1, airshipIn.getModuleActiveSlot1()));
        }
     ...
     * NOT USED ATM.
     */
    private void selectedModelViewWindow(EntityMachineFlying airshipIn, float partialTicks)
    {
    	//Draws the Main Control Panel Screen
    	this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/model_airship_view_window.png"));
    	
    	if(airshipIn.moduleActiveSlot1 == EnumsVM.ModuleType.BOMB_LESSER.getMetadata()
    	|| airshipIn.moduleActiveSlot1 == EnumsVM.ModuleType.BOMB_NORMAL.getMetadata()
    	|| airshipIn.moduleActiveSlot1 == EnumsVM.ModuleType.BOMB_GREATER.getMetadata())
    	{
	 ...
	 * NOT USED ATM.
	 */
    private void selectedModelMainPropeller(EntityMachineFlying airshipIn, float partialTicks, int locationIn)
    {
       GlStateManager.pushMatrix();
	 ...
	 */
    private void selectedModelMultiPropeller(EntityMachineFlying airshipIn, float partialTicks, int locationIn)
    {
       GlStateManager.pushMatrix();
	        ...
	        {
	        	if(Minecraft.getMinecraft().player.getRidingEntity() instanceof EntityMachineFlying)
	        	{
	        ...
	        if(locationIn == 2)
	        {
	            ...
	            this.modelAirshipPropeller.render(airshipIn, 0, 0.0F, 0.0F, 0, 0.0F, 0.0625F);
