package com.viesys.viesysairships.client.gui.guidebooks;
...
import com.viesys.viesysairships.client.gui.buttons.GuiButtonGuideBookVC;
    ...
    public void drawScreen(int parWidth, int parHeight, float p_73863_3_)
    {
		...
		if(currPage == 0)
		{
			GlStateManager.pushMatrix();
			{
				...
				drawCenteredString(fontRenderer, References.MOD_VERSION_NUMBER, 64, 144, 13565952);
