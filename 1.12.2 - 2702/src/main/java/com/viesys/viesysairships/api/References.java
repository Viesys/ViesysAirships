...
public class References {
	...
	public static final String MOD_ID = "viesysairships";
	public static final String MOD_ID_COLON = "viesysairships:";
	
	public static final String MOD_NAME = "Viesys Airships";
	public static final String MOD_VERSION_NUMBER = "5.9.13";
	...
	public static final String CONFIG_GUI = "com.viesys.viesysairships.api.gui.VCGuiFactory";
	public static final String CLIENT_PROXY_CLASS = "com.viesys.viesysairships.proxy.ClientProxy";
	public static final String SERVER_PROXY_CLASS = "com.viesys.viesysairships.proxy.ServerProxy";
