package com.viesys.viesysairships.common.tileentity;

import com.viesys.viesysairships.api.BlocksVC;
import com.viesys.viesysairships.common.entity.airships.containers.ContainerVC;
import com.viesys.viesysairships.common.entity.airships.slots.BatterySlotVC;
import com.viesys.viesysairships.common.entity.airships.slots.InventorySlotVC;
...
public class ContainerBatteryCharger extends ContainerVC {
    ...
    {
        return this.world.getBlockState(this.airship.getPos()).getBlock() != BlocksVC.AIRSHIP_WORKBENCH ? false : playerIn.getDistanceSq((double)this.airship.getPos().getX() + 0.5D, (double)this.airship.getPos().getY() + 0.5D, (double)this.airship.getPos().getZ() + 0.5D) <= 64.0D;
    }
