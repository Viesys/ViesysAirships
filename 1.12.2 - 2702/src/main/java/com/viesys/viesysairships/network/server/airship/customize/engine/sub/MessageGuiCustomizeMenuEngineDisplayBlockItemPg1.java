...
public class MessageGuiCustomizeMenuEngineDisplayBlockItemPg1 extends MessageBase<MessageGuiCustomizeMenuEngineDisplayBlockItemPg1> {
	...
	{
		player.openGui(ViesysAirships.instance, GuiHandler.GUI_APPEARANCE_MENU_ENGINE_BLOCKITEM, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
