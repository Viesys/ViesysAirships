...
public class MessageGuiCustomizeMenuFrameMain extends MessageBase<MessageGuiCustomizeMenuFrameMain> {
	...
	{
		player.openGui(ViesysAirships.instance, GuiHandler.GUI_APPEARANCE_MENU_FRAME_MAIN, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
