...
public class MessageGuiCustomizeMenuEngineDisplaySymbolPg1 extends MessageBase<MessageGuiCustomizeMenuEngineDisplaySymbolPg1> {
	...
	{
		player.openGui(ViesysAirships.instance, GuiHandler.GUI_APPEARANCE_MENU_ENGINE_SYMBOLS_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
