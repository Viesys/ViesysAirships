package com.viesys.viesysmachines.common.entity;
    ...
    public void controlAirship()
    {
    	if(this.isBeingRidden())
        {
            ...
            if(this.leftInputDown)
            {
            	...
            	*/
            	{
            		this.deltaRotation -= this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getBaseValue()*4;
            ...
            if (this.rightInputDown)
            {
            	...
            	*/
            	{
            		this.deltaRotation += this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getBaseValue()*4;//0.05;
            				//(finalAirshipSpeedTurn + (EnumsVC.MainTierFrame.byId(this.mainTierFrame).getSpeedModifier() * 4)) * 0.5F;
            	}
            }
            ...
            {
                f += this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getBaseValue();//0.005F;
            }
            ...
            *{*/   
            	if (this.backInputDown)
	            {
	            	...
	            	*/
	        	 {
	            		f -= this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getBaseValue() * 0.5;
	            	}
	            }
            //}
            ...
            if (this.upInputDown)
            {
            	/**if(isFuelBurning())
        		{
	    			...
	    			*/{
                		f1 += this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getBaseValue();
                				//finalAirshipSpeedUp + 
            ...
            {
                f1 -= this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getBaseValue();
                //0.05;//finalAirshipSpeedDown + (EnumsVC.MainTierFrame.byId(this.mainTierFrame).getSpeedModifier() / 4) + (this.speedModifier / 4);
            }
