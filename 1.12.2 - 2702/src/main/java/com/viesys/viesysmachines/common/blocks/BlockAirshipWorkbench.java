package com.viesys.viesysmachines.common.blocks;
...
import com.viesys.viesysmachines.common.blocks.basic.BlockEA;
...
public class BlockAirshipWorkbench extends BlockEA implements ITileEntityProvider {
	...
	public BlockAirshipWorkbench(String unlocalizedName) 
	{
		...
		this.setCreativeTab(ViesysMachines.tabViesCraftBlocks);
