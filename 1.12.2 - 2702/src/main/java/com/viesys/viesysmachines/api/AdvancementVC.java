...
public class AdvancementVC {
	
	public static Advancement airship_create_engine;
	public static Advancement airship_create_ignition;
	public static Advancement airship_create;
	public static Advancement airship_create_color;
	public static Advancement airship_create_module;
	
	public static Advancement airship_airborn;
	public static Advancement airship_water;
	public static Advancement airship_lava;
