...
public class MessageGuiCustomizeMenuBalloonTier1Pg1 extends MessageBase<MessageGuiCustomizeMenuBalloonTier1Pg1> {
	...
	{
		player.openGui(ViesysMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_BALLOON_TIER1_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
