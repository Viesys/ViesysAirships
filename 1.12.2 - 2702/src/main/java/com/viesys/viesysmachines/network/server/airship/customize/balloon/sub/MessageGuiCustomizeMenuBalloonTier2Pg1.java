...
public class MessageGuiCustomizeMenuBalloonTier2Pg1 extends MessageBase<MessageGuiCustomizeMenuBalloonTier2Pg1> {
	...
	{
		player.openGui(ViesysMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_BALLOON_TIER2_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
