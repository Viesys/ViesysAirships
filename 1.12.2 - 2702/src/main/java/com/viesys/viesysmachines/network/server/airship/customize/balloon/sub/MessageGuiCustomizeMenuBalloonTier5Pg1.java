...
public class MessageGuiCustomizeMenuBalloonTier5Pg1 extends MessageBase<MessageGuiCustomizeMenuBalloonTier5Pg1> {
	...
	{
		player.openGui(ViesysMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_BALLOON_TIER5_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
