package com.viesys.viesysmachines.client.gui.buttons;
...
public class GuiButtonMenuRedstoneVC extends GuiButton {
	
	protected static final ResourceLocation BUTTON_TEXTURES = new ResourceLocation(References.MOD_ID_COLON + "textures/gui/buttons_menu_redstone.png");
    protected int buttonLocationY;
    
	public GuiButtonMenuRedstoneVC(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText, int buttonLocationYIn) 
	{
