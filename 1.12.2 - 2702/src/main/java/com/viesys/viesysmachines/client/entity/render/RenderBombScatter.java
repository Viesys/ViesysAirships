...
import com.viesys.viesysmachines.client.entity.model.bomb.ModelBombScatter;
...
public class RenderBombScatter extends Render<EntityBombScatter> {
	
	/** Instance of V1 Balloon Model for rendering. */
	protected ModelBase modelBombScatter = new ModelBombScatter();
	
    public RenderBombScatter(RenderManager renderManagerIn)
    {
    ...
    @Override
    public void doRender(EntityBombScatter entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        this.bindTexture(new ResourceLocation(References.MOD_ID, "textures/models/bombs/bomb_scatter.png"));
        modelBombScatter.render(entity, partialTicks, 0F, 0F, 0F, 0F, 0.0625F);
    ...
    public void setupRotation(EntityBombScatter entity, float p_188311_2_, float p_188311_3_)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityBombScatter entity)
    {
        return null;
    }
