...
public class MessageHelperEventTrigger31Server extends MessageBase<MessageHelperEventTrigger31Server> {
	...
	@Override
	public void handleClientSide(MessageHelperEventTrigger31Server message, EntityPlayer player) 
	{
		
	}
	
	@Override
	public void handleServerSide(MessageHelperEventTrigger31Server message, EntityPlayer player) 
	{
		...
		NetworkHandler.sendToAllAround(new MessageHelperEventTrigger31Client(), 
