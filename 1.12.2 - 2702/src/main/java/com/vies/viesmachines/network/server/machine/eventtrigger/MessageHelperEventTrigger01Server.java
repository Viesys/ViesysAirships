...
public class MessageHelperEventTrigger01Server extends MessageBase<MessageHelperEventTrigger01Server> {
	...
	@Override
	public void handleClientSide(MessageHelperEventTrigger01Server message, EntityPlayer player) 
	{
		
	}
	
	@Override
	public void handleServerSide(MessageHelperEventTrigger01Server message, EntityPlayer player) 
	{
		...
		NetworkHandler.sendToAllAround(new MessageHelperEventTrigger01Client(), 
