...
public class MessageHelperEventTrigger41Server extends MessageBase<MessageHelperEventTrigger41Server> {
	...
	@Override
	public void handleClientSide(MessageHelperEventTrigger41Server message, EntityPlayer player) 
	{
		
	}
	
	@Override
	public void handleServerSide(MessageHelperEventTrigger41Server message, EntityPlayer player) 
	{
		...
		NetworkHandler.sendToAllAround(new MessageHelperEventTrigger41Client(), 
