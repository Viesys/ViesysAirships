...
public class MessageGuiCustomizeMenuCoreModelBalloonPg1 extends MessageBase<MessageGuiCustomizeMenuCoreModelBalloonPg1> {
	...
	{
		player.openGui(ViesMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_CORE_MODEL_BALLOON_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
