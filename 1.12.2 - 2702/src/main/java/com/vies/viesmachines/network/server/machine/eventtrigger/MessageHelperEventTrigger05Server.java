...
public class MessageHelperEventTrigger05Server extends MessageBase<MessageHelperEventTrigger05Server> {
	...
	@Override
	public void handleClientSide(MessageHelperEventTrigger05Server message, EntityPlayer player) 
	{
		
	}
	
	@Override
	public void handleServerSide(MessageHelperEventTrigger05Server message, EntityPlayer player) 
	{
		...
		NetworkHandler.sendToAllAround(new MessageHelperEventTrigger05Client(), 
