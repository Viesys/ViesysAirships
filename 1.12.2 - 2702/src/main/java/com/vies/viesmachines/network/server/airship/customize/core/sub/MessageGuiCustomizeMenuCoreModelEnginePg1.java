...
public class MessageGuiCustomizeMenuCoreModelEnginePg1 extends MessageBase<MessageGuiCustomizeMenuCoreModelEnginePg1> {
	...
	{
		player.openGui(ViesMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_CORE_MODEL_ENGINE_PG1, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
