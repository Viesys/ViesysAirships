...
public class MessageGuiCustomizeMenuEngineDisplayParticlePg1 extends MessageBase<MessageGuiCustomizeMenuEngineDisplayParticlePg1> {
	...
	{
		player.openGui(ViesMachines.instance, GuiHandler.GUI_APPEARANCE_MENU_ENGINE_PARTICLE, player.world, player.getPosition().getX(), player.getPosition().getY(), player.getPosition().getZ());
	}
}
