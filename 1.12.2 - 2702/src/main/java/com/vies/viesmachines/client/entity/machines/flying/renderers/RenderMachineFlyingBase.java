...
import com.vies.viesmachines.client.entity.model.ModelViewWindow;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonBalloon0;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonBalloon1;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonBalloon2;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonBalloon3;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonBalloon4;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonDisplaySymbol0;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonDisplaySymbol1;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonDisplaySymbol2;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonDisplaySymbol3;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonDisplaySymbol4;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonFrame0;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonFrame1;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonFrame2;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonFrame3;
import com.vies.viesmachines.client.entity.model.balloon.ModelBalloonFrame4;
import com.vies.viesmachines.client.entity.model.engine.ModelEngine0;
import com.vies.viesmachines.client.entity.model.engine.ModelEngine1;
import com.vies.viesmachines.client.entity.model.engine.ModelEngine2;
import com.vies.viesmachines.client.entity.model.engine.ModelEngine3;
import com.vies.viesmachines.client.entity.model.engine.ModelEngine4;
...
import com.vies.viesmachines.client.entity.model.frame.ModelFrame2;
import com.vies.viesmachines.client.entity.model.frame.ModelFrame3;
import com.vies.viesmachines.client.entity.model.frame.ModelFrame4;
...
public class RenderMachineFlyingBase extends Render<EntityMachineFlying> {
	...
	public RenderMachineFlyingBase(RenderManager renderManagerIn)
    {
    ...
    protected void renderEngineDisplaySymbol(EntityMachineFlying airshipIn, float partialTicks)
    {
    	...
    	{
    		this.renderBlockItem(airshipIn, new ItemStack(Item.getItemById(airshipIn.visualEngineDisplayItemstack), 1, airshipIn.visualEngineDisplayItemstackMeta), airshipIn.visualComponentTexture);
    	}
    	else if(airshipIn.getVisualEngineDisplayType() == 2)
    	{
    		///////this.renderEntityHead(airshipIn.engineDisplayHead, 0, 0, 0, airshipIn.coreModelVisualBalloon);
    	}
    	else if(airshipIn.getVisualEngineDisplayType() == 3)
    	{
    		//////this.renderSupporterHead(airshipIn.engineDisplaySupporterHead, 0, 0, 0, airshipIn.coreModelVisualBalloon);
    	}
    ...
    protected ModelBase getCurrentModelFrame(EntityMachineFlying airshipIn)
    {
    	switch(airshipIn.visualTypeModel)
    	{
	    	case 0:
    ...
    protected ModelBase getCurrentModelEngine(EntityMachineFlying airshipIn)
    {
    	switch(airshipIn.visualTypeModel)
    	{
	    	case 0:
    ...
    protected ModelBase getCurrentModelBalloonF(EntityMachineFlying airshipIn)
    {
    	switch(airshipIn.visualTypeModel)
    	{
	    	case 0:
    ...
    protected ModelBase getCurrentModelBalloonDS(EntityMachineFlying airshipIn)
    {
    	switch(airshipIn.visualTypeModel)
    	{
	    	case 0:
    ...
    protected ModelBase getCurrentModelBalloonB(EntityMachineFlying airshipIn)
    {
    	switch(airshipIn.visualTypeModel)
    	{
	    	case 0:
    ...
    protected void getCurrentModel(EntityMachineFlying entity)
    {
    ...
    protected int getMachineType(EntityMachineFlying entity)
    {
    	return entity.visualTypeModel;
    }
}
