...
public class ModelExtractorPowered extends ModelBase
{
    ModelRenderer powered_indicator_top;
    ModelRenderer powered_indicator_side_left;
    ModelRenderer powered_indicator_side_right;

    public ModelExtractorPowered()
    {
        this( 0.0f );
    }

    public ModelExtractorPowered( float par1 )
    {
   ...
   public void render(TileEntityExtractor te, float par2, float par3, float par4, float par5, float par6, float par7)
   {
