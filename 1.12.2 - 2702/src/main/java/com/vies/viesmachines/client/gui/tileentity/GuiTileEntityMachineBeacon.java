...
public class GuiTileEntityMachineBeacon extends GuiContainer {
	
	private InventoryPlayer playerInventory;
	private TileEntityMachineBeacon appliance;
	...
	public GuiTileEntityMachineBeacon(InventoryPlayer playerInventory, World worldIn, TileEntityMachineBeacon applianceIn)
	{
		super(new ContainerMachineBeacon(playerInventory, worldIn, applianceIn));
