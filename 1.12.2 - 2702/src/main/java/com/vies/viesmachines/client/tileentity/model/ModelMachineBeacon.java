...
public class ModelMachineBeacon extends ModelBase
{
    ModelRenderer base1;
    ModelRenderer base2;
    ...
    public ModelMachineBeacon()
    {
        this( 0.0f );
    }

    public ModelMachineBeacon( float par1 )
    {
   ...
   public void render(TileEntityMachineBeacon te, float par2, float par3, float par4, float par5, float par6, float par7)
   {
