...
import com.vies.viesmachines.common.entity.EntityThrownAirship;
...
public class RenderThrownAirship extends Render<EntityThrownAirship> {
	
	private Item itemModel = ItemsVC.ITEM_ENTITY_AIRSHIP;
	private float scale;
    
    public RenderThrownAirship(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityThrownAirship entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntityThrownAirship entity)
    {
