...
public class ModelMachineTransmogrifier extends ModelBase
{
    ModelRenderer base1;
    ModelRenderer base2;
    ...
    public ModelMachineTransmogrifier()
    {
        this( 0.0f );
    }

    public ModelMachineTransmogrifier( float par1 )
    {
   ...
   public void render(TileEntityMachineTransmogrifier te, float par2, float par3, float par4, float par5, float par6, float par7)
   {
