...
public class RenderEntityMachineFlying extends RenderLiving<EntityMachineFlying> {
	
	protected ModelBase modelAirship = new ModelFrame0();
	
    public RenderEntityMachineFlying(RenderManager rendermanagerIn, ModelBase modelbaseIn, float shadowsizeIn)
    {
    ...
    public boolean shouldRender(EntityMachineFlying livingEntity, ICamera camera, double camX, double camY, double camZ)
    {
    ...
    protected void renderLeash(EntityMachineFlying entityLivingIn, double x, double y, double z, float entityYaw, float partialTicks)
    {
