...
import com.vies.viesmachines.client.tileentity.model.ModelMachineBeacon;
...
public class RenderMachineBeacon extends TileEntitySpecialRenderer<TileEntityMachineBeacon> {
	...
	private ModelMachineBeacon model;
	//private ModelKitFabricatorPowered modelpowered;
	
	public RenderMachineBeacon() 
	{
		this.model = new ModelMachineBeacon();
	...
	public boolean isGlobalRenderer(TileEntityMachineBeacon te) 
	{
        return true;
    }
	...
	private void renderItemToProcess(TileEntityMachineBeacon te, double x, double y, double z, float partialTicks, int destroyStage)
    {
