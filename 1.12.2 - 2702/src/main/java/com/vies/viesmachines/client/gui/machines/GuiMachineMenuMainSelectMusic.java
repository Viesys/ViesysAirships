...
public class GuiMachineMenuMainSelectMusic extends GuiContainerVC {
    ...
    public void initGui() 
    {
    	...
    	GuiVC.button501 = new GuiButtonGeneral1VC(501, this.guiLeft + 60, this.guiTop + 197, 56, 14, References.localNameVC("gui.done"), 0);
	...
	{
		this.centeredString(fontRenderer, "Current Song", 88, 10, Color.BLACK.getRGB());
    ...
    private void updateCache()
    {
        ...
        for(int i = 0; i < ClientProxy.musicListRecord.size(); i++)
		{
		    ...
		    {
				this.setSong = i;
				NetworkHandler.sendToServer(new MessageGuiMusicSet());
		    }
		}
    }
