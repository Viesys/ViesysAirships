...
public class GuiMachineMenuMain extends GuiContainerVC {
	...
	private final ResourceLocation TEXTURE = new ResourceLocation(References.MOD_ID + ":" + "textures/gui/container_gui_airship_menu_main.png");
    ...
    public void initGui() 
    {
    	...
    	GuiVC.button49 = new GuiButtonGeneral1VC(72, this.guiLeft + 117, this.guiTop + 88, 52, 14, References.localNameVC("Select Song"), 0);
    	
    	GuiVC.button50 = new GuiButtonGeneral1VC(50, this.guiLeft + 153-28-8+2, this.guiTop + 119, 14, 14, References.localNameVC("S"), 2);
    	GuiVC.button51 = new GuiButtonGeneral1VC(51, this.guiLeft + 153-14-4+1, this.guiTop + 119, 14, 14, References.localNameVC("P"), 1);
    	GuiVC.button52 = new GuiButtonGeneral1VC(52, this.guiLeft + 153, this.guiTop + 119, 14, 14, References.localNameVC("R"), 3);
		...
		/**
		if(this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.MUSIC_LESSER.getMetadata()
		|| this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.MUSIC_NORMAL.getMetadata()
		|| this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.MUSIC_GREATER.getMetadata())
		{
		...
		/**
		if(this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.BOMB_LESSER.getMetadata()
		|| this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.BOMB_NORMAL.getMetadata()
		|| this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.BOMB_GREATER.getMetadata())
		{
    ...
    protected void actionPerformed(GuiButton parButton) 
    {
		...
		if (parButton.id == 51)
	    {
			...
			NetworkHandler.sendToServer(new MessageGuiMusicPlay());
	    }
		
		if (parButton.id == 50)
	    {
			this.machineId = this.machine.getEntityId();
			NetworkHandler.sendToServer(new MessageGuiMusicStop());
	    }
		
		if (parButton.id == 52)
	    {
			this.selectedSongId = References.random.nextInt(ClientProxy.musicListRecord.size()) + 1;
			
			this.machineId = this.machine.getEntityId();
			NetworkHandler.sendToServer(new MessageGuiMusicRandom());
	    }
		...
		if (parButton.id == 501)
	    {
			ItemStack bombslot = this.machine.inventory.getStackInSlot(51);
			...
			if(!bombslot.isEmpty())
			{
				...
				{
					if(this.machine.storedBombType1 == 64)
					{
						
					}
					else if(64 >= (bombslotCount + this.machine.storedBombType1))
					{
						NetworkHandler.sendToServer(new MessageHelperGuiMainMenuConsumeBomb1());
					}
					else if(64 < (bombslotCount + this.machine.storedBombType1))
					{
						bombslotCount = 64 - this.machine.storedBombType1;
				...
				{
					if(this.machine.storedBombType2 == 16)
					{
						
					}
					else if(16 >= (bombslotCount + this.machine.storedBombType2))
					{
						NetworkHandler.sendToServer(new MessageHelperGuiMainMenuConsumeBomb2());
					}
					else if(16 < (bombslotCount + this.machine.storedBombType2))
					{
						bombslotCount = 16 - this.machine.storedBombType2;
				...
				{
					if(this.machine.storedBombType2 == 8)
					{
						
					}
					else if(8 >= (bombslotCount + this.machine.storedBombType3))
					{
						NetworkHandler.sendToServer(new MessageHelperGuiMainMenuConsumeBomb3());
					}
					else if(8 < (bombslotCount + this.machine.storedBombType3))
					{
						bombslotCount = 8 - this.machine.storedBombType3;
		...
		*/
		...
		if (parButton.id == 72)
	    {
			NetworkHandler.sendToServer(new MessageMachineGuiMenuSelectMusic());
	    }
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) 
	{
		...
		/**
		if(this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.STORAGE_LESSER.getMetadata())
		{
			this.mc.getTextureManager().bindTexture(TEXTURE_STORAGE_LESSER);
		}
		if(this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.STORAGE_NORMAL.getMetadata())
		{
			this.mc.getTextureManager().bindTexture(TEXTURE_STORAGE_NORMAL);
		}
		if(this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.STORAGE_GREATER.getMetadata())
		{
		...
		|| this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.BOMB_GREATER.getMetadata())
		{
			...
			//if(this.machine.selectedModuleBomb == 2)
			//{
			...
			//}
			//else if(this.machine.selectedModuleBomb == 3)
			//{
			...
			if(this.machine.bombArmedToggle)
			{
			...
			if(!bombslot.isEmpty())
			{
				...
				if(this.machine.storedBombType1 >= 64
				&& this.machine.storedBombType1 >= 16
				&& this.machine.storedBombType1 >= 8)
				{
				...
				if(bombslot.getMetadata() == 3)
				{
					if(this.machine.storedBombType3 >= 8)
					{
						GuiVC.button501.enabled = false;
					}
					else
		...
		*
		//Draw "on" indicators
		if (this.machine.getStoredFuel() > 0)
        {
		...
		|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_NORMAL.getMetadata()
		|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_GREATER.getMetadata())
		{
		...
		*
		...
		|| this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.MUSIC_GREATER.getMetadata())
		{
			...
			GlStateManager.pushMatrix();
			{
				...
				this.drawCenteredString(fontRenderer, EnumsVC.AirshipSong.byId(this.machine.metaJukeboxSelectedSong).getRegistryName(), 0, 0, 255);
			}
			GlStateManager.popMatrix();
		}
    ...
    //{
        ...
        if (i == 0)
        {
        	i = this.machine.fuelItemStack + 1;
        }
   ...
   // }
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		this.centeredString(fontRenderer, "Machine Info", 60, 6, Color.BLACK.getRGB());
		
		this.centeredString(fontRenderer, "Fuel", 144, 6, Color.BLACK.getRGB());
		
		this.centeredString(fontRenderer, "Music", 144, 79, Color.BLACK.getRGB());
		
		if (!this.machine.broken)
        {
			//Current Song
			GlStateManager.pushMatrix();
			{
				...
				this.centeredString(fontRenderer, "Current Song:", 0, 0, Color.WHITE.getRGB());
			}
			GlStateManager.popMatrix();
			...
			GlStateManager.pushMatrix();
			{
				...
				, 1, false, TextFormatting.DARK_AQUA)	
		...
		GlStateManager.pushMatrix();
		{
			...
			String storedIn = TextFormatting.GREEN + "" + String.valueOf((int)(EnumsVC.MainTierCore.byId(this.machine.mainTierCore).getStoredRedstone()));
			
			if(this.machine.mainTierCore == 0)
			{
				storedIn = TextFormatting.BLACK + "-" + TextFormatting.GREEN + "" + String.valueOf((int)(EnumsVC.MainTierCore.byId(this.machine.mainTierCore).getStoredRedstone()));
			}
		...
		GlStateManager.pushMatrix();
		{
			...
			String speedIn = TextFormatting.BLACK + "-" + TextFormatting.GREEN + "+" + String.valueOf((int)(EnumsVC.MainTierFrame.byId(this.machine.mainTierFrame).getSpeedModifier() *100));
			
			if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.STORAGE_LESSER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.STORAGE_NORMAL.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.STORAGE_GREATER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.CRUISE_LESSER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.CRUISE_NORMAL.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.CRUISE_GREATER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_LESSER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_NORMAL.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_GREATER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.BOMB_LESSER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.BOMB_NORMAL.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.BOMB_GREATER.getMetadata())
			{
				speedIn = TextFormatting.BLACK + "-" + TextFormatting.RED + "+" + String.valueOf((int)(EnumsVC.MainTierFrame.byId(this.machine.mainTierFrame).getSpeedModifier() *100));
				
			}
				
				
				
			if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.SPEED_LESSER.getMetadata())
			{
				speedIn = TextFormatting.BLACK + "-" + TextFormatting.AQUA + "+" + String.valueOf((int)(EnumsVC.MainTierFrame.byId(this.machine.mainTierFrame).getSpeedModifier() *100)  + 1);
			}
			else if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.SPEED_NORMAL.getMetadata())
			{
				speedIn = TextFormatting.BLACK + "-" + TextFormatting.AQUA + "+" + String.valueOf((int)(EnumsVC.MainTierFrame.byId(this.machine.mainTierFrame).getSpeedModifier() *100)  + 2);
			}
			else if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.SPEED_GREATER.getMetadata())
			{
				speedIn = TextFormatting.BLACK + "-" + TextFormatting.AQUA + "+" + String.valueOf((int)(EnumsVC.MainTierFrame.byId(this.machine.mainTierFrame).getSpeedModifier() *100)  + 3);
			}
		...
		GlStateManager.pushMatrix();
		{
			...
			String fuelIn = TextFormatting.RED + "-" + String.valueOf(this.machine.getAirshipFuelTick());
			
			if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.FUEL_LESSER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.FUEL_NORMAL.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.FUEL_GREATER.getMetadata())
			{
				fuelIn = TextFormatting.GOLD + "-" + String.valueOf(this.machine.getAirshipFuelTick());
				
				if(this.machine.getMainTierEngine() == 5)
				{
					fuelIn = TextFormatting.BLACK + "-" + TextFormatting.GOLD + "-" + String.valueOf(this.machine.getAirshipFuelTick());
				}
			}
			else if (this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_LESSER.getMetadata()
					|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_NORMAL.getMetadata()
					|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_GREATER.getMetadata())
			{
		...
		GlStateManager.pushMatrix();
		{
			...
			String altitudeIn = TextFormatting.GREEN + String.valueOf((int)EnumsVC.MainTierBalloon.byId(this.machine.mainTierBalloon).getMaxAltitude());
			
			if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.ALTITUDE_LESSER.getMetadata())
			{
				altitudeIn = TextFormatting.AQUA + "225";
			}
			else if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.ALTITUDE_NORMAL.getMetadata())
			{
				altitudeIn = TextFormatting.AQUA + "250";
			}
			else if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.ALTITUDE_GREATER.getMetadata())
			{
				altitudeIn = TextFormatting.AQUA + "\u221e";
			}
			else if(this.machine.getMainTierBalloon() == 0)
			{
				altitudeIn = TextFormatting.BLACK + "-" + TextFormatting.GREEN + String.valueOf((int)EnumsVC.MainTierBalloon.byId(this.machine.mainTierBalloon).getMaxAltitude());
			}
		...
		GlStateManager.pushMatrix();
		{
			...
			if(this.machine.getMainTierCore() > 0)
			{
				this.drawItemStack(new ItemStack(InitItemsVC.UPGRADE_CORE
						, 1, this.machine.getMainTierCore()), 0, 0, "");
			}
		}
		GlStateManager.popMatrix();
		...
		GlStateManager.pushMatrix();
		{
			...
			if(this.machine.getMainTierFrame() > 0)
			{
				this.drawItemStack(new ItemStack(InitItemsVC.UPGRADE_FRAME, 1, this.machine.getMainTierFrame()), 0, 0, "");
			}
		}
		GlStateManager.popMatrix();
		...
		GlStateManager.pushMatrix();
		{
			...
			if(this.machine.getMainTierEngine() > 0)
			{
				this.drawItemStack(new ItemStack(InitItemsVC.UPGRADE_ENGINE, 1, this.machine.getMainTierEngine()), 0, 0, "");
			}
		}
		GlStateManager.popMatrix();
		...
		GlStateManager.pushMatrix();
		{
			...
			if(this.machine.getMainTierBalloon() > 0)
			{
				this.drawItemStack(new ItemStack(InitItemsVC.UPGRADE_BALLOON, 1, this.machine.getMainTierBalloon()), 0, 0, "");
			}
		}
		GlStateManager.popMatrix();
		...
		GlStateManager.pushMatrix();
		{
			...
			if(this.machine.getModuleActiveSlot1() > 0)
			{
				this.drawItemStack(new ItemStack(InitItemsVC.MODULE_TYPE, 1, this.machine.getModuleActiveSlot1()), 0, 0, "");
			}
		}
		GlStateManager.popMatrix();
		...
		|| this.machine.moduleActiveSlot1 == EnumsVC.ModuleType.BOMB_GREATER.getMetadata())
		{
			...
			GlStateManager.pushMatrix();
			{
				...
				this.fontRenderer.drawString(Integer.toString(this.machine.storedBombType1), 0, 0, Color.WHITE.getRGB(), false);
			}
			GlStateManager.popMatrix();
			...
			GlStateManager.pushMatrix();
			{
				...
				this.fontRenderer.drawString(Integer.toString(this.machine.storedBombType2), 0, 0, Color.WHITE.getRGB(), false);
			}
			GlStateManager.popMatrix();
			...
			GlStateManager.pushMatrix();
			{
				...
				this.fontRenderer.drawString(Integer.toString(this.machine.storedBombType3), 0, 0, Color.WHITE.getRGB(), false);
			}
			GlStateManager.popMatrix();
		...
		&& this.machine.inventory.getStackInSlot(0).isEmpty())
		{
			if(this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_LESSER.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_NORMAL.getMetadata()
			|| this.machine.getModuleActiveSlot1() == EnumsVC.ModuleType.INFINITE_FUEL_GREATER.getMetadata())
		...
		&& mouseY >= this.guiTop + 7 && mouseY <= this.guiTop + 30)
		{
			...
			if(this.isShiftKeyDown())
			{
				...
				{
					text.add(TextFormatting.GOLD + "- " + TextFormatting.GREEN + EnumsVC.ModuleType.byId(this.machine.getModuleActiveSlot1()).getLocalizedName());
				}
		...
		&& mouseY >= this.guiTop + 33 && mouseY <= this.guiTop + 57)
		{
			...
			if(this.isShiftKeyDown())
			{
				...
				text.add(TextFormatting.LIGHT_PURPLE + "");
				text.add(TextFormatting.WHITE + References.localNameVC("vc.gui.tt.basebonus") + ": " + TextFormatting.GREEN + EnumsVC.MainTierCore.byId(this.machine.mainTierCore).getStoredRedstone());
				...
				&& mouseY >= this.guiTop + 33 && mouseY <= this.guiTop + 57)
		{
			...
			if(this.isShiftKeyDown())
			{
				...
				text.add(TextFormatting.LIGHT_PURPLE + "");
				text.add(TextFormatting.WHITE + References.localNameVC("vc.gui.tt.basebonus") + ": " + TextFormatting.GREEN + "+" + this.machine.mainTierFrame);
				...
				&& mouseY >= this.guiTop + 33 && mouseY <= this.guiTop + 57)
		{
			...
			if(this.isShiftKeyDown())
			{
				...
				text.add(TextFormatting.LIGHT_PURPLE + "");
				text.add(TextFormatting.WHITE + References.localNameVC("vc.gui.tt.basebonus") + ": " + TextFormatting.RED + "-" + (EnumsVC.MainTierEngine.byId(this.machine.mainTierEngine).getFuelPerTick()));
				...
				&& mouseY >= this.guiTop + 33 && mouseY <= this.guiTop + 57)
		{
			...
			if(this.isShiftKeyDown())
			{
				...
				text.add(TextFormatting.LIGHT_PURPLE + "");
				text.add(TextFormatting.WHITE + References.localNameVC("vc.gui.tt.basebonus") + ": " + TextFormatting.GREEN + (EnumsVC.MainTierBalloon.byId(this.machine.mainTierBalloon).getMaxAltitude()));
