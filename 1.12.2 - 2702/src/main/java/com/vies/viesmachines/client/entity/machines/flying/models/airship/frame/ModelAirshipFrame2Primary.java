...
public class ModelAirshipFrame2Primary extends ModelBase
{
    ...
    ModelRenderer GROUND___DELETE;
    ModelRenderer Block;
    ModelRenderer BlockBig;

    public ModelAirshipFrame2Primary()
    {
        this( 0.0f );
    }

    public ModelAirshipFrame2Primary( float par1 )
    {
        ...
        GROUND___DELETE = new ModelRenderer( this, 0, -32 );
        GROUND___DELETE.setTextureSize( 128, 128 );
        GROUND___DELETE.addBox( -8F, -16F, -8F, 16, 16, 16);
        GROUND___DELETE.setRotationPoint( 0F, 26F, 0F );
        Block = new ModelRenderer( this, 1, 36 );
        Block.setTextureSize( 128, 128 );
        Block.addBox( -0.5F, -0.5F, -0.5F, 1, 1, 1);
        Block.setRotationPoint( 9.5F, 2F, 0F );
        BlockBig = new ModelRenderer( this, 0, 35 );
        BlockBig.setTextureSize( 128, 128 );
        BlockBig.addBox( -1F, -1F, -1F, 2, 2, 2);
        BlockBig.setRotationPoint( 9.5F, 2F, 9F );
    }
   ...
   public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
   {
        ...
        GROUND___DELETE.rotateAngleX = 0F;
        GROUND___DELETE.rotateAngleY = 0F;
        GROUND___DELETE.rotateAngleZ = 0F;
        GROUND___DELETE.renderWithRotation(par7);

        Block.rotateAngleX = 0.7853981F;
        Block.rotateAngleY = -1.570796F;
        Block.rotateAngleZ = -0.7853981F;
        Block.renderWithRotation(par7);

        BlockBig.rotateAngleX = 0.7853981F;
        BlockBig.rotateAngleY = -1.570796F;
        BlockBig.rotateAngleZ = -0.7853981F;
        BlockBig.renderWithRotation(par7);
