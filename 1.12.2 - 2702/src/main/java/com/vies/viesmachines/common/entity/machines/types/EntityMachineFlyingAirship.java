package com.vies.viesmachines.common.entity.machines.types;
...
public class EntityMachineFlyingAirship extends EntityMachineFlying {
	...
	{
		return EnumsVM.FlyingMachineVariantName.byId(this.getVisualModelComponent()).getUnlocalizedName();
	}
