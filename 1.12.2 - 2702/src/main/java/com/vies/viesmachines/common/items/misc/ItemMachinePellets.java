...
public class ItemMachinePellets extends Item {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn)
    {
		...
		tooltip.add("");
		tooltip.add(textColor + References.localNameVC(this.getUnlocalizedName() + ".tt.3") + " : " + VMConfiguration.machinePelletsBurnTime + " " + References.localNameVC("viesmachines.main.seconds"));
	}
