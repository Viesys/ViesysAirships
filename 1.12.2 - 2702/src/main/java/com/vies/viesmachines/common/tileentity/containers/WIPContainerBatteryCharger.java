...
public class WIPContainerBatteryCharger extends ContainerVC {
    ...
    private final WIPTileEntityBatteryCharger airship;
    
    public WIPContainerBatteryCharger(InventoryPlayer playerInventory, World worldIn, WIPTileEntityBatteryCharger tileEntityBatteryCharger)
    {
        this.world = worldIn;
    ...
    public boolean canInteractWith(EntityPlayer playerIn)
    {
		return false;
        //TODO
    	//return this.world.getBlockState(this.airship.getPos()).getBlock() != BlocksVM.AIRSHIP_WORKBENCH ? false : playerIn.getDistanceSq((double)this.airship.getPos().getX() + 0.5D, (double)this.airship.getPos().getY() + 0.5D, (double)this.airship.getPos().getZ() + 0.5D) <= 64.0D;
    }
