...
public class EnumsVC {
	...
	/**
     * Frame Tier enum - Dictates registry name, localized name, health modifier, machine points modifier.
     */
	public static enum FrameTier
    {
    	//STRING(meta, registry name, localized name, health, machinePoints)
		BASE(0, "tierbase", References.Old_I18n.translateToLocalFormatted("vc.enum.tier.0"), 1.0F, 128),
		ONE(1, "tier1", References.Old_I18n.translateToLocalFormatted("vc.enum.tier.1"), 10.0F, 256),
		TWO(2, "tier2", References.Old_I18n.translateToLocalFormatted("vc.enum.tier.2"), 20.0F, 512),
		THREE(3, "tier3", References.Old_I18n.translateToLocalFormatted("vc.enum.tier.3"), 40.0F, 1024);
		
		private final int metadata;
        private final String registryName;
        private final String localizedName;
        private final float health;
        private final int machinePoints;
        
        private FrameTier(int metadataIn, String registryNameIn, String localizedNameIn, float healthIn, int machinePointsIn)
        {
        	this.metadata = metadataIn;
            this.registryName = registryNameIn;
            this.localizedName = localizedNameIn;
            this.health = healthIn;
            this.machinePoints = machinePointsIn;
        }
        ...
        public float getMachinePointsModifier()
        {
         ...
         */
        public static EnumsVC.FrameTier byId(int id)
        {
        ...
        public static EnumsVC.FrameTier getTypeFromString(String nameIn)
        {
	...
	/**
     * Engine Tier enum - Dictates registry name, localized name, speed modifier.
     */
	public static enum EngineTier
    {
    	//STRING(meta, registry name, localized name, speedModifier, fuelEfficiency)
		BASE(0, "tierbase", References.Old_I18n.translateToLocalFormatted("vc.enum.tier.0"), 1.0F, 128),
		ONE(1, "tier1", References.Old_I18n.translateToLocalFormatted("vc.enum.tier.1"), 10.0F, 256),
		TWO(2, "tier2", References.Old_I18n.translateToLocalFormatted("vc.enum.tier.2"), 20.0F, 512),
		THREE(3, "tier3", References.Old_I18n.translateToLocalFormatted("vc.enum.tier.3"), 40.0F, 1024);
        ...
        private EngineTier(int metadataIn, String registryNameIn, String localizedNameIn, float healthIn, int machinePointsIn)
        {
        	this.metadata = metadataIn;
            this.registryName = registryNameIn;
            this.localizedName = localizedNameIn;
         ...
         * Get type by it's enum ordinal
         */
        public static EnumsVC.EngineTier byId(int id)
        {
            if (id < 0 || id >= values().length)
            {
                id = 0;
        ...
        public static EnumsVC.EngineTier getTypeFromString(String nameIn)
        {
            for (int i = 0; i < values().length; ++i)
            {
                if (values()[i].getRegistryName().equals(nameIn))
    ...
    {
    	//STRING(meta, registry name, localized name, HP, MP)
