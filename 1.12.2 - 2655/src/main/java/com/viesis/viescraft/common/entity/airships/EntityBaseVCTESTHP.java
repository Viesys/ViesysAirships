 ...
 */
public class EntityBaseVCTESTHP extends Entity {
    ...
    public EntityBaseVCTESTHP(World worldIn)
    {
        super(worldIn);
    ...
    public EntityBaseVCTESTHP(World worldIn, double x, double y, double z, 
